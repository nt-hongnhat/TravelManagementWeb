                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        <div class="form-floating mb-3 mb-md-0">
                            ...
                            <form:input class="form-control" id="inputName" type="text"
                    ...
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            ...
                            <form:input class="form-control" id="email" type="email"
                                        placeholder="Nhập số điện thoại..." path="email" required="required"/>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            ...
                            <form:input class="form-control" id="address" type="text"
                                        placeholder="Nhập địa chỉ..." path="address" required="required"/>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-floating mb-3">
                            <label for="note">Ghi chú</label>
                            <form:input class="form-control" id="note" type="text"
