    ...
    <div class="row">
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <c:forEach items="${yearCb}" var="yearCbItem" >
                    <a class="dropdown-item" href="<c:url value="/admin/chartNumberOfTour" />?year=${yearCbItem}">${yearCbItem}</a>
                </c:forEach>
            </div>
        </div>
        <div class="col-md-6" style="margin-top: 1rem">
            ...
            <table class="table table-bordered table-dark">
                <h5 class="text-center">Bảng thống kê số lượng tour trong tháng (năm ${year})</h5>
                <thead>
                <tr>
                ...
                <tbody>
                    <c:forEach items="${toursStatsByMonth}" var="item">
                        <tr>
        ...
        <div class="col-md-6" style="margin-top: 1rem">
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-chart-bar me-1"></i>
                    Số lượng tour theo năm
                </div>
                <div class="card-body"><canvas id="myBarChartYear" width="100%" height="50"></canvas></div>
                <%--<div class="card-footer small text-muted">Updated yesterday at 11:59 PM</div>--%>
            </div>
            <table class="table table-bordered table-dark">
                <h5 class="text-center">Bảng thống kê số lượng tour các năm</h5>
                <thead>
                <tr>
                    <th scope="col">Năm</th>
                    <th scope="col">Số lượng tour</th>
                ...
                <tbody>
                <c:forEach items="${toursStatsByYear}" var="item">
                    <tr>
                        <th scope="row">${item[0]}</th>
                        <td>${item[1]}</td>
                    </tr>
